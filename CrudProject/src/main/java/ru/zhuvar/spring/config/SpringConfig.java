package ru.zhuvar.spring.config;
...
@Configuration
@EnableWebMvc
@ComponentScan("ru.zhuvar.spring")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        driverManagerDataSource.setDriverClassName(env.getRequiredProperty("spring.datasource.driver"));
